...
#Region " Class Property of DepotOut Info "

    <Serializable()> _
    Public Class clsPropDepotOut
        Inherits clsProp
        ...
        Public Property JobNo() As String
            ...
            End Get
        End Property
        Public Property DepotOutNo() As String
            Set(ByVal value As String)
                If _DepotOutNo <> value Then
                    _DepotOutNo = value
                End If
            End Set
            Get
