...
#Region " Class Collection of BusinessParty Info "

    <Serializable()> _
    Public Class colBusinessParty
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropBusinessParty(ConClass.NewIdValue)
        End Function
    End Class
#End Region
#Region " Class Server of BusinessParty Info "

    <Serializable()> _
    Public Class clsBusinessParty
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "BusinessParty"
        End Sub
        Private Function InsertBusinessParty(ByRef propBusinessParty As clsPropBusinessParty, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propBusinessParty.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propBusinessParty.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateBusinessParty(ByVal propBusinessParty As clsPropBusinessParty, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteBusinessParty(ByVal propBusinessParty As clsPropBusinessParty, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propBusinessParty.TrxNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_Rcbp1_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Public Overrides Function GetDetail(ByVal intId As Long) As clsProp
            ...
            End Try
        End Function
        Public Overrides Function GetDetail(ByVal strBusinessPartyCode As String) As clsProp
            Dim ds As DataSet
            Dim dt As DataTable
            Try
                Dim param(0) As SqlParameter
                param(0) = New SqlParameter("@BusinessPartyCode", SqlDbType.NVarChar, 10)
                param(0).Value = strBusinessPartyCode
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropBusinessParty
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.BusinessPartyDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropBusinessParty = CType(CurrentProp, clsPropBusinessParty)
            blnReturn = InsertBusinessParty(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropBusinessParty = CType(CurrentProp, clsPropBusinessParty)
            blnReturn = UpdateBusinessParty(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropBusinessParty = CType(CurrentProp, clsPropBusinessParty)
            blnReturn = DeleteBusinessParty(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
