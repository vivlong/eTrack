...
#Region " Class Property of AddressBook Info "

    <Serializable()> _
    Public Class clsPropAddressBook
        Inherits clsProp
        Private _TrxNo As Int64
        Private _AddressBookCode As String = ""
        Private _AddressBookName As String = ""
        ...
        Public Property AddressBookCode() As String
            Set(ByVal value As String)
                If _AddressBookCode <> value Then
                    _AddressBookCode = value
                End If
            End Set
            Get
                Return _AddressBookCode
            End Get
        End Property
        ' 
        Public Property AddressBookName() As String
            Set(ByVal value As String)
                If _AddressBookName <> value Then
