...
#Region " Class Collection of SaleActivity Info "

    <Serializable()> _
    Public Class colSaleActivity
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropSaleActivity(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of SaleActivity Info "

    <Serializable()> _
    Public Class clsSaleActivity
        Inherits clsBaseSrv
        ...
        Private Function InsertSaleActivity(ByRef propSaleActivity As clsPropSaleActivity, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propSaleActivity.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propSaleActivity.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateSaleActivity(ByVal propSaleActivity As clsPropSaleActivity, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteSaleActivity(ByVal propSaleActivity As clsPropSaleActivity, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propSaleActivity.TrxNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_smsa1_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropSaleActivity
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.SaleActivityDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropSaleActivity = CType(CurrentProp, clsPropSaleActivity)
            blnReturn = InsertSaleActivity(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropSaleActivity = CType(CurrentProp, clsPropSaleActivity)
            blnReturn = UpdateSaleActivity(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropSaleActivity = CType(CurrentProp, clsPropSaleActivity)
            blnReturn = DeleteSaleActivity(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
