...
#Region " Class Collection of ChargeCalculation Info "

    <Serializable()> _
    Public Class colChargeCalculation
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropChargeCalculation(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of ChargeCalculation Info "

    <Serializable()> _
    Public Class clsChargeCalculation
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal intUserId As String)
            ...
            colProp = New colChargeCalculation()
            Title = "ChargeCalculation"
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "ChargeCalculation"
        End Sub
        Private Function InsertChargeCalculation(ByRef propChargeCalculation As clsPropChargeCalculation, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propChargeCalculation.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propChargeCalculation.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateChargeCalculation(ByVal propChargeCalculation As clsPropChargeCalculation, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteChargeCalculation(ByVal propChargeCalculation As clsPropChargeCalculation, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propChargeCalculation.TrxNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_smct1_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Public Overrides Function GetDetail(ByVal intId As String) As clsProp
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_smct1_Detail", param)
                dt = ds.Tables(0)
                Return colProp.RecordToProp(dt, 0, 0)
            Catch
                Return colProp.NewOneProp()
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropChargeCalculation
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.ChargeCalculationDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropChargeCalculation = CType(CurrentProp, clsPropChargeCalculation)
            blnReturn = InsertChargeCalculation(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropChargeCalculation = CType(CurrentProp, clsPropChargeCalculation)
            blnReturn = UpdateChargeCalculation(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropChargeCalculation = CType(CurrentProp, clsPropChargeCalculation)
            blnReturn = DeleteChargeCalculation(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
