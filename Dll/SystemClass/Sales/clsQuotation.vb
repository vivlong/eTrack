...
#Region " Class Collection of Quotation Info "

    <Serializable()> _
    Public Class colQuotation
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropQuotation(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of Quotation Info "
    ...
    Public Class clsQuotation
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "Quotation"
        End Sub
        Private Function InsertQuotation(ByRef propQuotation As clsPropQuotation, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propQuotation.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propQuotation.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateQuotation(ByVal propQuotation As clsPropQuotation, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteQuotation(ByVal propQuotation As clsPropQuotation, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propQuotation.TrxNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                If Query = "Amfq1" Then
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_amfq1_List", param)
                Else
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_smfq1_List", param)
                End If
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropQuotation
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.QuotationDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropQuotation = CType(CurrentProp, clsPropQuotation)
            blnReturn = InsertQuotation(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropQuotation = CType(CurrentProp, clsPropQuotation)
            blnReturn = UpdateQuotation(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropQuotation = CType(CurrentProp, clsPropQuotation)
            blnReturn = DeleteQuotation(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
