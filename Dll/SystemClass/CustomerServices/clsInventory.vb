...
#Region " Class Collection of Inventory Info "

    <Serializable()> _
    Public Class colInventory
        Inherits colclsProp
    ...
    End Class
#End Region
#Region " Class Server of Inventory Info "
    ...
    Public Class clsInventory
        ...
        Private Function InsertInventory(ByRef propInventory As clsPropWMS, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propInventory.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "spi_Track_omtx1", param)
                If intResult > 0 Then
                    propInventory.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateInventory(ByVal propInventory As clsPropWMS, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                ...
                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "spu_Track_Inventory", param)
                If intResult > 0 Then
                    Return True
                Else
                    Return False
            ...
            End Try
        End Function
        Private Function DeleteInventory(ByVal propInventory As clsPropWMS, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter
                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propInventory.TrxNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                param(8) = New SqlParameter("@Condition", SqlDbType.NVarChar, 20)
                ...
                'End If
                'param(9) = New SqlParameter("@Condition1", SqlDbType.NVarChar, 50)
                'param(9).Value = Condition1

                'param(10) = New SqlParameter("@Condition2", SqlDbType.NVarChar, 50)
                'param(10).Value = Condition2

                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_Impm1_Inventory2_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                End If
                'tmpProp.InventoryDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            blnReturn = InsertInventory(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropWMS = CType(CurrentProp, clsPropWMS)
            blnReturn = UpdateInventory(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropWMS = CType(CurrentProp, clsPropWMS)
            blnReturn = DeleteInventory(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
