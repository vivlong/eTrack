...
#Region " Class Collection of Tracking Info "
    <Serializable()> _
    Public Class colTracking
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropTracking(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of Tracking Info "
    ...
    Public Class clsTracking
        ...
        Private Function InsertTracking(ByRef propTracking As clsPropTracking, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propTracking.JobNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propTracking.JobNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateTracking(ByVal propTracking As clsPropTracking, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteTracking(ByVal propTracking As clsPropTracking, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propTracking.JobNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                param(1).Value = Where + Condition1
                ...
                Else
                    ...
                    dt = ds.Tables(1)
                    HttpContext.Current.Session("strFiles") = param(8).Value.ToString()
                End If
                Return dt
            Catch
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropTracking
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.TrackingDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropTracking = CType(CurrentProp, clsPropTracking)
            blnReturn = InsertTracking(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropTracking = CType(CurrentProp, clsPropTracking)
            blnReturn = UpdateTracking(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropTracking = CType(CurrentProp, clsPropTracking)
            blnReturn = DeleteTracking(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
