...
#Region " Class Property of ExportBooking Info "

    <Serializable()> _
    Public Class clsPropExportBooking
#Region "Property"
        Inherits clsProp
        Private _TrxNo As Integer
        Private _SeblTrxNo As Integer
        ...
        Private _CargoReceiptDateTime As DateTime
        Private _CargoReceiptFlag As String = ""
        Private _CargoReceiptRemark As String = ""
        ...
        Private _OtherCharge As Decimal
        ...
        Private _SecondForwardAgentName As String = ""
        ...
        Private _ShippingOrderNo As String = ""
        ...
        Private _StorageCharge As Decimal
...
#End Region
#Region " Class Property of StatusCode"
        Public Property TrxNo() As Integer
            ...
            End Get
        End Property
        Public Property SeblTrxNo() As Integer
            Set(ByVal value As Integer)
                If _SeblTrxNo <> value Then
                    _SeblTrxNo = value
                End If
            End Set
            Get
        ...
        Public Property CargoReceiptDateTime() As DateTime
            Set(ByVal value As DateTime)
                If _CargoReceiptDateTime <> value Then
                    _CargoReceiptDateTime = value
                End If
            End Set
            Get
                Return _CargoReceiptDateTime
            End Get
        End Property

        Public Property CargoReceiptFlag() As String
            Set(ByVal value As String)
                If _CargoReceiptFlag <> value Then
                    _CargoReceiptFlag = value
                End If
            End Set
            Get
                Return _CargoReceiptFlag
            End Get
        End Property

        Public Property CargoReceiptRemark() As String
            Set(ByVal value As String)
                If _CargoReceiptRemark <> value Then
                    _CargoReceiptRemark = value
                End If
            End Set
            Get
                Return _CargoReceiptRemark
            End Get
        End Property
        ...
        Public Property ForwardAgentName() As String
            Set(ByVal value As String)
                If _ForwardAgentName <> value Then
                    _ForwardAgentName = value
                End If
            End Set
            Get
                Return _ForwardAgentName
            End Get
        End Property
        ...
        Public Property FreeDay() As Integer
            Set(ByVal value As Integer)
                If _FreeDay <> value Then
                    _FreeDay = value
                End If
            End Set
            Get
        ...
        Public Property GateCharge() As Decimal
            Set(ByVal value As Decimal)
                If _GateCharge <> value Then
                    _GateCharge = value
                End If
            End Set
            Get
        ...
        Public Property HistoryFlag() As String
            Set(ByVal value As String)
                If _HistoryFlag <> value Then
                    _HistoryFlag = value
                End If
            End Set
            Get
        ...
        Public Property Laden() As DateTime
            Set(ByVal value As DateTime)
                If _Laden <> value Then
                    _Laden = value
                End If
            End Set
            Get
        ...
        Public Property NoOfCycle() As Integer
            Set(ByVal value As Integer)
                If _NoOfCycle <> value Then
                    _NoOfCycle = value
                End If
            End Set
            Get
        ...
        Public Property SecondForwardAgentName() As String
            Set(ByVal value As String)
                If _SecondForwardAgentName <> value Then
                    _SecondForwardAgentName = value
                End If
            End Set
            Get
                Return _SecondForwardAgentName
            End Get
        End Property
        ...
        Public Property ShippingOrderNo() As String
            Set(ByVal value As String)
                If _ShippingOrderNo <> value Then
        ...
        Public Property StorageCharge() As Decimal
            Set(ByVal value As Decimal)
                If _StorageCharge <> value Then
                    _StorageCharge = value
                End If
            End Set
            Get
                Return _StorageCharge
            End Get
        End Property
...
#Region "set new"
        Public Sub New(ByVal intId As Integer)
            ...
            _BookingSeqNo = ""
            _CargoClass = ""
            _CargoReceiptDateTime = ConDateTime.MinDate
            _CargoReceiptFlag = ""
            _CargoReceiptRemark = ""
            _CargoType = ""
            _CarMarking = ""
