...
#Region " Class of ContainerEnquiry byDeo"

    <Serializable()> _
    Public Class clsContainerEnquiry_Sebl1_Sibl1
        Inherits clsQuery
        ...
        Private Function addOrderby(ByVal dt As DataTable) As DataTable
            ...
            If dt.Rows.Count > 1 Then
                For i = 0 To dt.Rows.Count - 1
                    If dt.Rows(i)("ContainerNo") IsNot Nothing Then
                        If strvOrderBy <> dt.Rows(i)("ContainerNo").ToString.Trim Then
                            Dim dr As DataRow = dt.NewRow()
                            dr("ContainerNo") = dt.Rows(i)("ContainerNo").ToString
                            dt.Rows.InsertAt(dr, i) ' //insert new line at;
                        End If
                        strvOrderBy = dt.Rows(i)("ContainerNo").ToString
                    End If
                Next
            End If
            Return dt
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConDbConn.ConnectionString, CommandType.StoredProcedure, "sps_Track_Sebl_Sibl_ContainerEnquiry", param)
                dt = ds.Tables(0)
...
#Region " Class of Collection of Property Sea Freight "
    ...
    <Serializable()> _
    Public Class colContainerEnquiry_Sebl1_Sibl1
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropContainerEnquiry(ConClass.NewIdValue)
        End Function

    End Class

#End Region
#Region " Class of ContainerEnquiry_Sebl1_Sibl1 Server "

    <Serializable()> _
    Public Class clsContainerEnquiry_Sebl1_Sibl1Edit
        Inherits clsBaseSrv

        Public Sub New(ByVal intUserId As String)
            MyBase.New(intUserId)
            colProp = New colContainerEnquiry_Sebl1_Sibl1()
            Title = "ContainerEnquiry_Sebl1_Sibl1"
        ...
        Public Overrides Function GetDetail(ByVal strKey As String) As clsProp
            ...
            Try
                ...
                param(0) = New SqlParameter("@TableName", SqlDbType.NVarChar, 20)
                param(0).Value = strKey.Split("A")(0)
                param(1) = New SqlParameter("@TrxNo", SqlDbType.Int, 20)
                param(1).Value = strKey.Split("A")(1)
                param(2) = New SqlParameter("@LineItemNo", SqlDbType.Int, 20)
                param(2).Value = strKey.Split("A")(2)
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_ContainerEnquiry_Detail", param)
                dt = ds.Tables(0)
                Return colProp.RecordToProp(dt, 0, 0)
            Catch
                Return colProp.NewOneProp()
