...
#Region " Class Collection of AirwayBill Info "

    <Serializable()> _
    Public Class colAirwayBill
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropAirwayBill(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of AirwayBill Info "

    <Serializable()> _
    Public Class clsAirwayBill
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "AirwayBill"
        End Sub
        Private Function InsertAirwayBill(ByRef propAirwayBill As clsPropAirwayBill, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propAirwayBill.AwbNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propAirwayBill.AwbNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateAirwayBill(ByVal propAirwayBill As clsPropAirwayBill, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteAirwayBill(ByVal propAirwayBill As clsPropAirwayBill, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propAirwayBill.AwbNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_aeaw1_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropAirwayBill
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.AirwayBillDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropAirwayBill = CType(CurrentProp, clsPropAirwayBill)
            blnReturn = InsertAirwayBill(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropAirwayBill = CType(CurrentProp, clsPropAirwayBill)
            blnReturn = UpdateAirwayBill(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropAirwayBill = CType(CurrentProp, clsPropAirwayBill)
            blnReturn = DeleteAirwayBill(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
