...
#Region " Class Collection of AgeingReport Info "

    <Serializable()> _
    Public Class colAgeingReport
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropAgeingReport(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of AgeingReport Info "

    <Serializable()> _
    Public Class clsAgeingReport
        Inherits clsBaseSrv
        ...
        Private Function InsertAgeingReport(ByRef propAgeingReport As clsPropAgeingReport, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propAgeingReport.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propAgeingReport.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateAgeingReport(ByVal propAgeingReport As clsPropAgeingReport, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteAgeingReport(ByVal propAgeingReport As clsPropAgeingReport, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propAgeingReport.TrxNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_Slcu1_Ageing_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropAgeingReport
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.AgeingReportDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropAgeingReport = CType(CurrentProp, clsPropAgeingReport)
            blnReturn = InsertAgeingReport(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropAgeingReport = CType(CurrentProp, clsPropAgeingReport)
            blnReturn = UpdateAgeingReport(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropAgeingReport = CType(CurrentProp, clsPropAgeingReport)
            blnReturn = DeleteAgeingReport(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
