...
#Region " Class ExportBookingList "

    <Serializable()> _
    Public Class colExportBookingList
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropExportBookingList(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of ExportBookingList Info "

    <Serializable()> _
    Public Class clsExportBookingList
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal intUserId As String)
            ...
            colProp = New colExportBookingList()
            Title = "ExportBookingList"
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "ExportBookingList"
        End Sub
        Private Function InsertExportBookingList(ByRef propExportBookingList As clsPropExportBookingList, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propExportBookingList.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propExportBookingList.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateExportBookingList(ByVal propExportBookingList As clsPropExportBookingList, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteExportBookingList(ByVal propExportBookingList As clsPropExportBookingList, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propExportBookingList.TrxNo
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropExportBookingList
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.ExportBookingListDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropExportBookingList = CType(CurrentProp, clsPropExportBookingList)
            blnReturn = InsertExportBookingList(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropExportBookingList = CType(CurrentProp, clsPropExportBookingList)
            blnReturn = UpdateExportBookingList(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropExportBookingList = CType(CurrentProp, clsPropExportBookingList)
            blnReturn = DeleteExportBookingList(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
