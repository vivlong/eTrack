...
#Region " Class CargoLoadPlan "

    <Serializable()> _
    Public Class colCargoLoadPlan
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropCargoLoadPlan(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of CargoLoadPlan Info "

    <Serializable()> _
    Public Class clsCargoLoadPlan
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "CargoLoadPlan"
        End Sub
        Private Function InsertCargoLoadPlan(ByRef propCargoLoadPlan As clsPropCargoLoadPlan, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propCargoLoadPlan.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propCargoLoadPlan.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateCargoLoadPlan(ByVal propCargoLoadPlan As clsPropCargoLoadPlan, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteCargoLoadPlan(ByVal propCargoLoadPlan As clsPropCargoLoadPlan, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propCargoLoadPlan.TrxNo
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropCargoLoadPlan
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.CargoLoadPlanDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropCargoLoadPlan = CType(CurrentProp, clsPropCargoLoadPlan)
            blnReturn = InsertCargoLoadPlan(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropCargoLoadPlan = CType(CurrentProp, clsPropCargoLoadPlan)
            blnReturn = UpdateCargoLoadPlan(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropCargoLoadPlan = CType(CurrentProp, clsPropCargoLoadPlan)
            blnReturn = DeleteCargoLoadPlan(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
