...
#Region " Class Collection of BillofLading Info "

    <Serializable()> _
    Public Class colBillofLading
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropBillofLading(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of BillofLading Info "

    <Serializable()> _
    Public Class clsBillofLading
        Inherits clsBaseSrv
        ...
        Private Function InsertBillofLading(ByRef propBillofLading As clsPropBillofLading, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propBillofLading.TrxNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propBillofLading.TrxNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateBillofLading(ByVal propBillofLading As clsPropBillofLading, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteBillofLading(ByVal propBillofLading As clsPropBillofLading, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@TrxNo", SqlDbType.BigInt)
                param(0).Value = propBillofLading.TrxNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                If Query = "Sebl1" Then
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_sebl1_List", param)
                Else
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_sibl1_List", param)
                End If
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropBillofLading
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.BillofLadingDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropBillofLading = CType(CurrentProp, clsPropBillofLading)
            blnReturn = InsertBillofLading(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropBillofLading = CType(CurrentProp, clsPropBillofLading)
            blnReturn = UpdateBillofLading(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropBillofLading = CType(CurrentProp, clsPropBillofLading)
            blnReturn = DeleteBillofLading(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
