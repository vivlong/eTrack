...
#Region " Class Collection of CustomerAnalysis Info "

    <Serializable()> _
    Public Class colCustomerAnalysis
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropCustomerAnalysis(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of CustomerAnalysis Info "

    <Serializable()> _
    Public Class clsCustomerAnalysis
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal intUserId As String)
            ...
            colProp = New colCustomerAnalysis()
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "CustomerAnalysis"
        End Sub
        Private Function InsertCustomerAnalysis(ByRef propCustomerAnalysis As clsPropCustomerAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propCustomerAnalysis.AwbNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propCustomerAnalysis.AwbNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateCustomerAnalysis(ByVal propCustomerAnalysis As clsPropCustomerAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteCustomerAnalysis(ByVal propCustomerAnalysis As clsPropCustomerAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@AwbNo", SqlDbType.BigInt)
                param(0).Value = propCustomerAnalysis.AwbNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                If Query = "Aeaw1_Manifest" Then
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_Aeaw1_Manifest_List", param)
                Else
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_Sebl1_Manifest_List", param)
                End If
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropCustomerAnalysis
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.CustomerAnalysisDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropCustomerAnalysis = CType(CurrentProp, clsPropCustomerAnalysis)
            blnReturn = InsertCustomerAnalysis(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropCustomerAnalysis = CType(CurrentProp, clsPropCustomerAnalysis)
            blnReturn = UpdateCustomerAnalysis(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropCustomerAnalysis = CType(CurrentProp, clsPropCustomerAnalysis)
            blnReturn = DeleteCustomerAnalysis(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
