...
#Region " Class Collection of UserAnalysis Info "

    <Serializable()> _
    Public Class colUserAnalysis
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropUserAnalysis(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of UserAnalysis Info "

    <Serializable()> _
    Public Class clsUserAnalysis
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "UserAnalysis"
        End Sub
        Private Function InsertUserAnalysis(ByRef propUserAnalysis As clsPropUserAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propUserAnalysis.JobNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propUserAnalysis.JobNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateUserAnalysis(ByVal propUserAnalysis As clsPropUserAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteUserAnalysis(ByVal propUserAnalysis As clsPropUserAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@AwbNo", SqlDbType.BigInt)
                param(0).Value = propUserAnalysis.JobNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_Jmjm1_Verification_List", param)
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropUserAnalysis
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.UserAnalysisDate = GeneralFun.StringToDate(strRow(1))

                tmpProp.JobNo = strRow(51)
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropUserAnalysis = CType(CurrentProp, clsPropUserAnalysis)
            blnReturn = InsertUserAnalysis(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropUserAnalysis = CType(CurrentProp, clsPropUserAnalysis)
            blnReturn = UpdateUserAnalysis(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropUserAnalysis = CType(CurrentProp, clsPropUserAnalysis)
            blnReturn = DeleteUserAnalysis(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
