...
#Region " Class Collection of JobAnalysis Info "

    <Serializable()> _
    Public Class colJobAnalysis
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropJobAnalysis(ConClass.NewIdValue.ToString)
        End Function
    End Class
#End Region
#Region " Class Server of JobAnalysis Info "

    <Serializable()> _
    Public Class clsJobAnalysis
        Inherits clsBaseSrv
        ...
        Public Sub New(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String)
            ...
            Title = "JobAnalysis"
        End Sub
        Private Function InsertJobAnalysis(ByRef propJobAnalysis As clsPropJobAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(51) As SqlParameter
                param(0) = New SqlParameter("@OrderDate", SqlDbType.NVarChar, 50)

                param(51).Value = propJobAnalysis.AwbNo

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "", param)
                If intResult > 0 Then
                    propJobAnalysis.AwbNo = intResult
                    Return True
                Else
                    Return False
                End If
            ...
            End Try
        End Function
        Private Function UpdateJobAnalysis(ByVal propJobAnalysis As clsPropJobAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteJobAnalysis(ByVal propJobAnalysis As clsPropJobAnalysis, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                Dim param(0) As SqlParameter

                param(0) = New SqlParameter("@AwbNo", SqlDbType.BigInt)
                param(0).Value = propJobAnalysis.AwbNo
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                If Query = "Aeaw1_Manifest" Then
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_aeaw1_Mf_List", param)
                Else
                    ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_sebl1_Mf_List", param)
                End If
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
        ...
        Public Overrides Function ModifyCurrent(ByVal strValue As String) As Boolean
            ...
            Else
                ...
                Dim tmpProp As clsPropJobAnalysis
                If tmpId < 0 Then
                ...
                End If
                'tmpProp.JobAnalysisDate = GeneralFun.StringToDate(strRow(1))
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropJobAnalysis = CType(CurrentProp, clsPropJobAnalysis)
            blnReturn = InsertJobAnalysis(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropJobAnalysis = CType(CurrentProp, clsPropJobAnalysis)
            blnReturn = UpdateJobAnalysis(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropJobAnalysis = CType(CurrentProp, clsPropJobAnalysis)
            blnReturn = DeleteJobAnalysis(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
