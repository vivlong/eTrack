...
#Region " Class Collection of FunctionInfo "

    <Serializable()> _
    Public Class colFunctionInfo
        Inherits colclsProp
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropFunctionInfo(ConClass.NewIdValue)
        End Function
    End Class
#End Region
#Region " Class Server of FunctionInfo "
    ...
    Public Class clsFunctionInfo
        ...
        End Sub
        Private Function InsertFunctionInfo(ByRef propFI As clsPropFunctionInfo, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(23) As SqlParameter

                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "spi_Track_FunctionInfo", param)
                If intResult > 0 Then
            ...
            End Try
        End Function
        Private Function UpdateFunctionInfo(ByVal propFI As clsPropFunctionInfo, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
                Dim param(15) As SqlParameter


                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "spu_Track_FunctionInfo", param)
                If intResult > 0 Then
                    Return True
                Else
                    Return False
            ...
            End Try
        End Function
        Private Function DeleteFunctionInfo(ByVal propFI As clsPropFunctionInfo, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
                ...
                Dim intResult As Integer
                intResult = SqlHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "spd_Track_FunctionInfo", param)
                If intResult > 0 Then
                    Return True
                Else
                    Return False
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_FunctionInfo_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Public Overrides Function GetDetail(ByVal intId As Long) As clsProp
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_eTrack_FunctionInfo_Detail", param)
                dt = ds.Tables(0)
                Return colProp.RecordToProp(dt, 0, 0)
            Catch
                Return colProp.NewOneProp()
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropFunctionInfo = CType(CurrentProp, clsPropFunctionInfo)
            blnReturn = InsertFunctionInfo(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function UpdateData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropFunctionInfo = CType(CurrentProp, clsPropFunctionInfo)
            blnReturn = UpdateFunctionInfo(tmpProp, conn, trans, strMsg)
            If blnReturn Then
                If strMsg = "" Then
        ...
        Protected Overrides Function DeleteData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Dim blnReturn As Boolean
            Dim tmpProp As clsPropFunctionInfo = CType(CurrentProp, clsPropFunctionInfo)
            blnReturn = DeleteFunctionInfo(tmpProp, conn, trans, 1, strMsg)
            If blnReturn Then
                If strMsg = "" Then
