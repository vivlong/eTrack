...
#Region " Class Collection of GridSet "
    ...
    Public Class colGridSet
        ...
        Public Overrides Function NewOneProp() As clsProp
            Return New clsPropGridSet(ConClass.NewIdValue)
        End Function
    End Class
#End Region
#Region " Class Server of GridSet "
    ...
    Public Class clsGridSet
        ...
        End Sub
        Private Function InsertGridSet(ByRef propFI As clsPropGridSet, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function UpdateGridSet(ByVal propFI As clsPropGridSet, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            Try
            ...
            End Try
        End Function
        Private Function DeleteGridSet(ByVal propFI As clsPropGridSet, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByVal intDeleteType As Integer, ByRef strMsg As String) As Boolean
            Try
        ...
        Protected Overrides Function GetList() As DataTable
            ...
            Try
                ...
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "sps_Track_GridSet_List", param)
                If PageSize = 0 Then
                    'Total Page Count
                    PageCount = 1
                    'Total Record Count
        ...
        Protected Overrides Function InsertData(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, ByRef strMsg As String) As Boolean
            ...
            Dim tmpProp As clsPropGridSet = CType(CurrentProp, clsPropGridSet)
