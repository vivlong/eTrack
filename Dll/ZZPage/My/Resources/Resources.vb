...
Namespace ZZPage.My.Resources
    <HideModuleName(), DebuggerNonUserCode(), CompilerGenerated(), GeneratedCode("System.Resources.Tools.StronglyTypedResourceBuilder", "2.0.0.0"), StandardModule()> _
        ...
        Friend Shared ReadOnly Property ResourceManager As ResourceManager
            Get
                If Object.ReferenceEquals(Resources.resourceMan, Nothing) Then
                    Dim manager2 As New ResourceManager("ZZPage.Resources", GetType(Resources).Assembly)
