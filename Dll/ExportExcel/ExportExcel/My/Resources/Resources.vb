...
Namespace ExportExcel.My.Resources
    <HideModuleName(), StandardModule(), CompilerGenerated(), DebuggerNonUserCode(), GeneratedCode("System.Resources.Tools.StronglyTypedResourceBuilder", "2.0.0.0")> _
        ...
        Friend Shared ReadOnly Property ResourceManager As ResourceManager
            Get
                If Object.ReferenceEquals(Resources.resourceMan, Nothing) Then
                    Dim manager2 As New ResourceManager("ExportExcel.Resources", GetType(Resources).Assembly)
