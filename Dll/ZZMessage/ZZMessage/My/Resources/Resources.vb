...
Namespace ZZMessage.My.Resources
    <CompilerGenerated(), GeneratedCode("System.Resources.Tools.StronglyTypedResourceBuilder", "2.0.0.0"), DebuggerNonUserCode(), StandardModule(), HideModuleName()> _
        ...
        Friend Shared ReadOnly Property ResourceManager As ResourceManager
            Get
                If Object.ReferenceEquals(Resources.resourceMan, Nothing) Then
                    Dim manager2 As New ResourceManager("ZZMessage.Resources", GetType(Resources).Assembly)
