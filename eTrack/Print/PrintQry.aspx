<%@ Page Language="VB" AutoEventWireup="true" CodeFile="PrintQry.aspx.vb" Inherits="PrintQry" %>
...
<body>
    ...
    <form id="frmPrintQry" runat="server">
        <div class="NoPrint">
            ...
            <asp:Button ID="btnPrintPreview" Text="Preview" runat="server" CssClass="Button" />
            <asp:Button ID="btnPageSetup" Text="Page Setup" runat="server" CssClass="Button" />
            <asp:Button ID="btnEmail" Text="Email" runat="server" CssClass="Button" />
        </div>
        <center>
            <table>
                <tr>
