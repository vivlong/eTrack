<%@ Page Language="VB" AutoEventWireup="true" CodeFile="SaleActivity.aspx.vb" Inherits="SaleActivity" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crSaleActivity.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
    function GetQuery() 
...
<body onload="DivAutoSize(120);" onresize="DivAutoSize(120);">
    <form id="frmSaleActivity" runat="server">
        <div id="divTitle">
           &nbsp  <asp:Label ID="Label1" CssClass="Title" runat="server" Text="<%$ Resources:lblTitle.Text %>"></asp:Label>
        </div>
        ...
        <div id="divSearch" class="divSearch">
            ...
            <asp:DropDownList ID="drpSearch" runat="server" CssClass="fLeft drpSearch"  Width="120px" />
