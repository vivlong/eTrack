<%@ Page Language="VB" AutoEventWireup="true" CodeFile="ChargeCalculation.aspx.vb"
    Inherits="ChargeCalculation" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crChargeCalculation.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
        function GetQuery() 
...
<body onload="DivAutoSize(120);" onresize="DivAutoSize(120);">
    <form id="frmChargeCalculation" runat="server">
    <div id="divTitle">
        &nbsp
