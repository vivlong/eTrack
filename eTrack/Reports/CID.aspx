<%@ Page Language="VB" AutoEventWireup="true" CodeFile="CID.aspx.vb" Inherits="CID" %>
...
<head runat="server">
    ...
    <link href="App_Themes/CID.css" rel="Stylesheet" type="text/css" />
    ...
    <!--#include file="JavaScript/CID.js" -->
...
<body onload="ResetSize(12,0)">
    ...
    <div id="divForm">
        ...
        <div id="divMiddle" class="divBorder">
            <div class="divline">
                <asp:Label ID="lblDateFrom" runat="server" CssClass="Label lbl" Text="<%$ Resources:lblDateFrom%>"></asp:Label>
                <asp:TextBox ID="txtDateFrom" runat="server" CssClass="TextBox lblDate" />
                <asp:Button ID="btnDateFrom" runat="server" CssClass="Button bntDate" Text="..."
                    UseSubmitBehavior="False" />
            </div>
            <div class="divline">
                <asp:Label ID="lblDateTo" runat="server" CssClass="Label lbl" Text="<%$ Resources:lblDateTo%>"></asp:Label>
                <asp:TextBox ID="txtDateTo" runat="server" CssClass="TextBox lblDate" />
