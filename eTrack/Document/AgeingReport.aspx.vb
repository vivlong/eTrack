...
Partial Class AgeingReport
    ...
    Protected Overrides Function BindSourceData(ByVal intUserId As String, ByVal intPage As Integer, ByVal intSize As Integer) As Boolean
        ...
        objColumns = DynamicGridViewFun.GetColumnFromSqlFile("Slcu1_Ageing", gvwSource, TemplateType.ListPrint, intUserId, Session("LoginType").ToString)
 ...
 objList = NewObjectList(objUser.UserId, objUser.RoleName, PageFun.GetFunNo(Page))
    ...
    Protected Sub gvwSource_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            intTrxNo = CType(tmpProp, clsPropAgeingReport).CustomerCode
            ...
            'imgPrint.Attributes.Add("OnClick", "PrintDetail('AgeingReport','int','{vw_Slcu1.Trx No}','" + intTrxNo + "','Documents\\rptSltx19-2a.rpt');return false;")
            'rptSltx17a
            imgPrint.Attributes.Add("OnClick", "PrintCrystalReport('rptSltx17a.rpt','{vw_Slcu1.Customer Code}','" + intTrxNo + "','Char');return false;")
