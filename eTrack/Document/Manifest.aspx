<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Manifest.aspx.vb" Inherits="Manifest" %>
...
<head>
    ...
    <!--#include file="JavaScript/Manifest.js" -->
...
<body onload="DivAutoSize(120);" onresize="DivAutoSize(120);">
    ...
    <div id="divPage">
        ...
        <div id="hid_div">
            <asp:HiddenField ID="hidVal_Manifest" runat="server" Value="1" />
        </div>
    </div>
    </form>
</body>
