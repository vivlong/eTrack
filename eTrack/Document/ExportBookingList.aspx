<%@ Page Language="VB" AutoEventWireup="true" CodeFile="ExportBookingList.aspx.vb" Inherits="ExportBookingList" %>
...
<body onload="DivAutoSize(120);" onresize="DivAutoSize(120);">
    <form id="frmExportBookingList" runat="server">
    <div id="divTitle">
        &nbsp
        <asp:Label ID="Label1" CssClass="Title" runat="server" Text="Export Booing List"></asp:Label>
    </div>
