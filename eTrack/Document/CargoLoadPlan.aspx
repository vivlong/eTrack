<%@ Page Language="VB" AutoEventWireup="true" CodeFile="CargoLoadPlan.aspx.vb" Inherits="CargoLoadPlan" %>
...
<body onload="DivAutoSize(120);" onresize="DivAutoSize(120);">
    <form id="frmCargoLoadPlan" runat="server">
    <div id="divTitle">
        &nbsp
        <asp:Label ID="Label1" CssClass="Title" runat="server" Text="Export Booking List"></asp:Label>
    </div>
