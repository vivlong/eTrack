...
Partial Class CargoLoadPlan
    ...
    Protected Overrides Function NewObjectList(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String) As clsBaseSrv
        Return New clsCargoLoadPlan(strUserId, RoleName, strFunNo)
    End Function
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        MyBase.OnInit(e)
        Me.TableName = "Sebk1_CargoLoadPlan"
    ...
    Protected Sub gvwSource_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            strTrxNo = CType(tmpProp, clsPropCargoLoadPlan).TrxNo
            'Popupmenu
            If strTrxNo > "" Then
            ...
            'imgPrint.Attributes.Add("OnClick", "PrintDetail('CargoLoadPlan','','{vw_aeaw.Awb No}','" + strTrxNo + "','Documents\\rptAeaw11a.rpt');return false;")
            imgPrint.Attributes.Add("OnClick", "PrintCrystalReport('rptSebk14-2.rpt','{vw_Sebk1.Trx No}','" + strTrxNo + "','Int');return false;")
