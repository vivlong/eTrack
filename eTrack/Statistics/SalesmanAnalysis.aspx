<%@ Page Language="VB" AutoEventWireup="true" CodeFile="SalesmanAnalysis.aspx.vb"
    Inherits="SalesmanAnalysis" %>
...
<head>
    ...
    <link href="App_Themes/SalesmanAnalysis.css" rel="stylesheet" type="text/css" />
     ...
     function SelectedDivl(selectId,LiCount)
   {
    ...
    if(selectId==1)
    { 
          document.getElementById('div_Customer').style.display ="inline";
          ...
          document.getElementById('divdrpSearch').style.display ="none";
          document.getElementById('divShipment').style.display ="inline";
    }
    else if(selectId==2)
    {
       ...
       document.getElementById('divdrToplist').style.display ="none";
       document.getElementById('divdrpSearch').style.display ="none";
       document.getElementById('divShipment').style.display ="none";
    }
      else if(selectId==3)  
      {
          document.getElementById('div_Customer').style.display ="inline";
          ...
          document.getElementById('divDate').style.display ="none";
          document.getElementById('divYM').style.display ="inline";
          document.getElementById('divdrpSearch').style.display ="inline";
          document.getElementById('divShipment').style.display ="none";
      }
   }
    </script>
...
<body onload="DivAutoSize(160);" onresize="DivAutoSize(160);">
    ...
    <div id="divTopNav" runat="server" class="divSearch">
        <ul id="ulTopNav">
            <li>
                <asp:Label ID="a1" CssClass="f12e navNml navOn" runat="server" Width="125px" onclick="javascript:SelectedDivl(1,3);"
                    Text="<%$ Resources:a1 %>"></asp:Label></li>
            <li>
                <asp:Label ID="a2" CssClass="f12c navNml noSep" runat="server" Width="120px" onclick="javascript:SelectedDivl(2,3);"
                    Text="<%$ Resources:a2 %>"></asp:Label></li>
            <li>
                <asp:Label ID="a3" CssClass="f12c navNml noSep" runat="server" Width="125px" onclick="javascript:SelectedDivl(3,3);"
    ...
    <div id="divSearch" class="divCustomerAnalysis divSearch" style="height: 53px;" runat="server">
        <div class="divline">
            ...
            <div id="divdrpSearch" style="display: none; padding-left: 30px;">
                <%--<asp:Label ID="lblcustomerType" runat="server" Text="<%$ Resources:lblcustomerType %>" CssClass="Label" />
                &nbsp&nbsp--%>
                <asp:DropDownList ID="drpSearch" runat="server" Width="120px" />
            </div>
            <div id="divShipment" style="display: inline; padding-left: 30px;">
                <%--<asp:Label ID="lblcustomerType" runat="server" Text="<%$ Resources:lblcustomerType %>" CssClass="Label" />
                &nbsp&nbsp--%>
                <asp:DropDownList ID="drShipment" runat="server" Width="120px" />
            </div>
        </div>
        <div id="divdrTopButton" class="divline">
            ...
            <div id="div_Customer" runat="server" style="display: none">
                <asp:Label ID="lblSalesman" runat="server" Text="<%$ Resources:lblSalesman %>" CssClass="Label lblcustomer" />&nbsp
            </div>
