...
Partial Class CustomerAnalysis
    ...
    Private Sub InitSearchListField()
        ...
        drMonth.Text = strM
        Dim tb As DataTable
        tb = BaseSelectSrvr.GetData("select distinct VendorType from plvt1", "")
        drpSearch.DataSource = tb
        drpSearch.DataTextField = "VendorType"
        drpSearch.DataValueField = "VendorType"
        drpSearch.DataBind()
        'drTopButton
...
objList = NewObjectList(objUser.UserId, objUser.RoleName, PageFun.GetFunNo(Page))
            ...
            div_Vendor.Style.Clear()
            div_Vendor.Style.Add("display", "inline")
