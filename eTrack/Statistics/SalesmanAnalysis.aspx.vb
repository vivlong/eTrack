...
Partial Class SalesmanAnalysis
    ...
    Private Sub InitSearchListField()
        ...
        drMonth.Text = strM
        ''Field
        drpSearch.Items.Add(New ListItem("Customer Visit", "Customer Visit"))
        drpSearch.Items.Add(New ListItem("No of Quotation", "No of Quotation"))
        ...
        'drShipment
        drShipment.Items.Add(New ListItem("Shipment", "Shipment"))
        drShipment.Items.Add(New ListItem("Tonnage", "Tonnage"))
        drShipment.Items.Add(New ListItem("Sales", "Sales"))
        drShipment.Items.Add(New ListItem("Profit", "Profit"))
    End Sub
