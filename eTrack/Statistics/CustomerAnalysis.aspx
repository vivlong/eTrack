<%@ Page Language="VB" AutoEventWireup="true" CodeFile="CustomerAnalysis.aspx.vb"
    Inherits="CustomerAnalysis" %>
...
<body onload="DivAutoSize(160);" onresize="DivAutoSize(160);">
    ...
    <div id="divSearch" class="divCustomerAnalysis divSearch " style="height: 53px;"
        runat="server">
        <div class="divline">
            ...
            <div id="divdrpSearch" style="display: inline; padding-left: 30px;">
                <asp:Label ID="lblcustomerType" runat="server" Text="<%$ Resources:lblcustomerType %>"
                    CssClass="Label" />
                &nbsp&nbsp
        ...
        <div id="divdrTopButton" class="divline">
            ...
            <div id="div_Customer" runat="server" style="display: none">
                <asp:Label ID="lblCustomer" runat="server" Text="<%$ Resources:lblCustomer %>" CssClass="Label lblcustomer" />&nbsp
            </div>
