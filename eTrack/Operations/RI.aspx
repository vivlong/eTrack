<%@ Page Language="VB" AutoEventWireup="true" CodeFile="RI.aspx.vb" Inherits="RI" %>
...
<body onload="ResetSize(11,0);setConfig('<%=ExportConfig%>');">
    ...
    <div>
        ...
        <div id="divSearch">
            ...
            <asp:DropDownList ID="drpSearch" runat="server" CssClass="fLeft DropList" />
            <asp:TextBox ID="txtSearch" runat="server" CssClass="fLeft txInput txtSearch" />
            <asp:Button ID="btnSearch" runat="server" CssClass="Button btnFnt" Text="Search"
