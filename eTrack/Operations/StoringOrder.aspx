<%@ Page Language="VB" AutoEventWireup="true" CodeFile="StoringOrder.aspx.vb" Inherits="StoringOrder" %>
...
function ShowAdvance(){
 var ret=WindowDialog("../Reference/AdvContainer.aspx",400,250);
if (ret) {
   if(ret!=""){
    strWhere=ret;
    GetPageData(null,-1);   
...
<body onload="ResetSize(11,0);setConfig('<%=ExportConfig%>');">
    ...
    <div>
        ...
        <div id="divSearch">
            ...
            <asp:Button ID="btnAdvance" runat="server" CssClass="btnFnt" Text="Advance" UseSubmitBehavior="false"
                Width="60px" />
