...
Partial Class ExportEvent
    ...
    Protected Overrides Function NewObjectList(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String) As clsBaseSrv
        Return New clsExportEvent(strUserId, RoleName, strFunNo)
    End Function
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        MyBase.OnInit(e)
        Me.TableName = "ctcl1_ExportEvent"
    ...
    Protected Sub gvwSource_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            'KeyValue 
            Dim intTrxNo As String = CType(tmpProp, clsPropExportEvent).TrxNo.ToString()
            ...
            '-----------------check new status-------------------------------------------------------------- 
            Dim ds As DataSet
            Dim ContainerNo As String = CType(tmpProp, clsPropExportEvent).ContainerNo.ToString()
            Dim State As String = CType(tmpProp, clsPropExportEvent).State.ToString()
            Dim EventDateTime As DateTime = CType(tmpProp, clsPropExportEvent).EventDate
