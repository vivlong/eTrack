...
Partial Class MidCELEdit
    ...
    Protected Overrides Function BindSourceData(ByVal intUserId As String, ByVal intPage As Integer, ByVal intSize As Integer) As Boolean
        ...
        dt = clsUser.ListSub(objUser.RoleName, "0108")
        Dim i As Integer
        Dim flag As String = ""
        ...
        End If
        If objList.Where.IndexOf("ContainerNo=") < 0 Then
            objList.Where += " and ContainerNo='" + hidContainerNo.Value + "'"
        End If
        objList.Query = "Mid"
    ...
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        MyBase.OnInit(e)
        Me.TableName = "ctcl1_history"
        Me.MyGridView = gvwSource
        Me.ColumnFrom = ColumnFile.Sql
        Me.CurrentSortField = "EventDate"
        Me.SortDesc = True
    End Sub
    ...
    Private Sub InitSearchListField()
        ...
        For i = 0 To objColumns.Column.Count - 1
            ...
            If _ColumnInfo.FieldName.ToLower <> "containerno" Then
...
objList = NewObjectList(objUser.UserId, objUser.RoleName, PageFun.GetFunNo(Page))
            ...
            If Request("Id") IsNot Nothing Then
                objList.Where = " and ContainerNo='" + Request("Id").ToString + "'"
                hidContainerNo.Value = Request("Id").ToString
            End If
            'Get First Page Data
