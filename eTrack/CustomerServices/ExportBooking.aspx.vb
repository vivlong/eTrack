...
Partial Class ExportBooking
    ...
    Protected Overrides Function BindSourceData(ByVal intUserId As String, ByVal intPage As Integer, ByVal intSize As Integer) As Boolean
        ...
        If Session("LoginType") = 0 Then
            objList.Where += "  and BookingCustomerName='" + objUser.UserName + "' "
    ...
    Protected Overrides Function NewObjectList(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String) As clsBaseSrv
        Return New clsExportBooking(strUserId, RoleName, strFunNo)
    End Function
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        MyBase.OnInit(e)
        Me.TableName = "Rcvy1_ExportBooking"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not IsPostBack Then
            ...
            End If
            'bylin
            strFunNo = (PageFun.GetFunNo(Page)).ToString
            '-----byRoot
    ...
    Protected Sub gvwSource_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.Header Then
            ...
            If imgInsert IsNot Nothing Then
                imgInsert.Attributes.Add("OnClick", "openSelect();return false;")
            End If
        ElseIf e.Row.RowType = DataControlRowType.DataRow Then
            ...
            intTrxNo = CType(tmpProp, clsPropExportBooking).TrxNo
            'Popupmenu
            If intTrxNo > 0 Then
            ...
            For i = 0 To objColumns.Column.Count - 1
                ...
                Else
                    Select Case _ColumnInfo.FieldType
                        ...
                        Case DbType.Date, DbType.DateTime
                            strFieldName = _ColumnInfo.FieldName
                            Dim str As String = CType(tmpProp, clsPropExportBooking).PickupDateTime.ToString
                            If str <> "" Then
                                Dim dtmTemp As DateTime = CType(tmpProp, clsPropExportBooking).PickupDateTime
                                If dtmTemp <= ConDateTime.MinDate Then
                                    e.Row.Cells(i + 1).Text = ""
                                Else
            ...
            If objList.EditPrivilege AndAlso tmpProp.IsDeleted = 0 Then
                imgEdit.Attributes.Add("OnClick", "EditDetail(" + intTrxNo.ToString() + ",'" + strFunNo + "');return false;")
            Else
                imgEdit.Visible = False
            End If
            e.Row.Attributes.Add("ondblclick", "EditDetail(" + intTrxNo.ToString() + ",'" + strFunNo + "');return false;")
            'Insert
            Dim imgInsert As Image = CType(e.Row.FindControl("imgInsert"), Image)
            If objList.NewPrivilege Then
                imgInsert.Attributes.Add("OnClick", "openSelect();return false;")
