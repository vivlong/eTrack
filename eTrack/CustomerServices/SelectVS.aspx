<%@ Page Language="VB" AutoEventWireup="true" CodeFile="SelectVS.aspx.vb" Inherits="SelectVS" %>
...
function GetQueryValue()
{
  ...
  if($("#hidPod").val()=="")
  {return "";}
 else{ return " and PortOfDischargeName in (" + $("#hidPod") + ")";}
}
...
{ 
  var strUrl="../loading.aspx?tourl="+"Print/crVesselSchedule.aspx?Condition="+urlEncode(GetQueryValue())+"";
  window.open(strUrl);
}
...
<body style="height: 20px; width: 898px; overflow-x: hidden;">
    ...
    <div class="NoPrint">
        <table cellpadding="0" cellspacing="0" border="0" style="width: 850px; margin-left: 30px;">
            <tr style="border: 0px">
                <td style="border: 0px">
            ...
            <tr style="border: 0px">
                ...
                <td style="border: 0px; width: 40px">
                    <asp:LinkButton ID="btnPrint" runat="server" UseSubmitBehavior="false"><img src="../Images/Customer/FilePrint.png" alt=""/></asp:LinkButton>
                </td>
            </tr>
        </table>
    </div>
    ...
    <asp:HiddenField ID="hidPod" runat="server" />
    </form>
</body>
</html>
