<%@ Page Language="VB" AutoEventWireup="true" CodeFile="MoutiExportShipmentStatus.aspx.vb"
    Inherits="MoutiExportShipmentStatus" %>
...
<body>
    ...
    <div id="divSource" style="height: 480px;">
        <asp:GridView ID="gvwSource" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvwSource_RowDataBound"
            ...
            <Columns>
                <asp:BoundField HeaderText="Port of Loading" DataField="PortOfLoadingCode">
                    <ItemStyle CssClass="colNo taLeft" Width="200px" />
                    <HeaderStyle CssClass="colNo taCenter " Width="200px" />
                </asp:BoundField>
            </Columns>
            <Columns>
                <asp:BoundField HeaderText="Port of Discharge" DataField="PortofDischargeCode">
                    <ItemStyle CssClass="colNo taLeft" Width="200px" />
                    <HeaderStyle CssClass="colNo taCenter " Width="200px" />
                </asp:BoundField>
            </Columns>
            <Columns>
                <asp:BoundField HeaderText="ETD" DataField="EtdDate">
                    <ItemStyle CssClass="colNo taLeft" Width="200px" />
                    <HeaderStyle CssClass="colNo taCenter " Width="200px" />
                </asp:BoundField>
            </Columns>
            <Columns>
                <asp:BoundField HeaderText="ETA" DataField="EtaDate">
                    <ItemStyle CssClass="colNo taLeft" Width="200px" />
                    <HeaderStyle CssClass="colNo taCenter " Width="200px" />
                </asp:BoundField>
            </Columns>
    ...
    <div id="divBottomNav">
        <asp:Button ID="btnClose" runat="server" Text="Exit" CssClass="Button" UseSubmitBehavior="False" />
    </div>
