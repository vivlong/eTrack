...
Class PersonList
    ...
    Private SelectPersonInfo As clsSelectPersonInfo
   ...
   Public Function GetQueryData(strQuery As String) As String
      Dim objUser As clsUser = Nothing
      If PageFun.GetCurrentUserInfo(Page, objUser) Then
         SelectPersonInfo = New clsSelectPersonInfo(objUser.UserId, CType(PageFun.GetRequestValueAsInt(Page, "Type"), PersonType))
         gvwSource.DataSource = SelectPersonInfo.GetPersonList(strQuery)
         gvwSource.DataBind()
      End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) '
        If Not IsPostBack Then
            ...
            If Not PageFun.GetCurrentUserInfo(Page, objUser) Then
                Return
            End If
            'New Object SelectPersonInfo
            If Not (SelectPersonInfo Is Nothing) Then
                SelectPersonInfo = Nothing
            End If
            SelectPersonInfo = New clsSelectPersonInfo(objUser.UserId, CType(PageFun.GetRequestValueAsInt(Page, "Type"), PersonType))
   ...
   Public Sub BindSourceData()
      gvwSource.DataSource = SelectPersonInfo.GetPersonList("")
      gvwSource.DataBind()
    End Sub

   Protected Sub gvwSource_RowDataBound(sender As Object, e As GridViewRowEventArgs)
      If e.Row.RowType = DataControlRowType.DataRow Then
         If SelectPersonInfo.SourceIsEmpty Then
            e.Row.Visible = False
         Else
