...
Namespace Ntools
    Public Class tool
        ...
        Public Shared Function addZero(ByVal intNum As Integer) As String
            ...
            End If
        End Function
        Public Shared Function showState(ByVal stateCode As String) As String
            Dim stateName As String = ""
            If stateCode.Trim = "" Then : Return "" : End If
            Select Case stateCode.ToLower
                Case "sd" : Return "Pending Survery"
                Case "dm" : Return "Damage"
                Case "av" : Return "Available"
                Case "wr" : Return "Washing Rquired"
                Case Else : Return ""
            End Select
        End Function
