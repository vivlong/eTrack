...
Partial Class EquipmentType
    ...
    Private Sub printData(ByVal intUserId As String)
        'Session("printData") = Nothing
        'Session("intUserId") = Nothing
        'objList.GetListInfo(1, 0)
        'Session("printData") = objList.ArrProp
    ...
    Protected Overrides Function NewObjectList(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String) As clsBaseSrv
        Return New clsEquipmentType(strUserId, RoleName, strFunNo)
    End Function
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        ...
        Me.CurrentSortField = "ContainerType"
        Me.SortDesc = False
    End Sub
...
objList = NewObjectList(objUser.UserId, objUser.RoleName, PageFun.GetFunNo(Page))
            ...
            'btnPrint.Attributes.Add("OnClick", ConPrintLimit.PrintButtonOnClick(objUser.PagePara.QuerySize, GetType(clsTankDetailReport).AssemblyQualifiedName, TableName, 4, True))
    ...
    Protected Sub gvwSource_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            'KeyValue 
            Dim strContainerType As String = CType(tmpProp, clsPropEquipmentType).ContainerType
            'Popupmenu
            If strContainerType <> "" Then
                e.Row.Attributes.Add("oncontextmenu", "ShowMenu('" + strContainerType + "');return false;")
            End If
            'Row color
            ...
            If objList.DeletePrivilege AndAlso tmpProp.IsDeleted = 0 AndAlso Not tmpProp.IsAdd Then
                If CType(tmpProp, clsPropEquipmentType).Deletable Then
                    imgDelete.Attributes.Add("OnClick", "DeleteDetail('" + strContainerType + "');return false;")
                Else
            ...
            If objList.RestorePrivilege And tmpProp.IsDeleted = 1 And Not tmpProp.IsAdd Then
                imgRestore.Attributes.Add("OnClick", "UndeleteDetail('" + strContainerType + "');return false;")
            Else
            ...
            If objList.EditPrivilege AndAlso tmpProp.IsDeleted = 0 AndAlso Not tmpProp.IsAdd Then
                imgEdit.Attributes.Add("OnClick", "EditDetail('" + strContainerType + "');return false;")
                e.Row.Attributes.Add("ondblclick", "EditDetail('" + strContainerType + "');return false;")
            Else
