<%@ Page Language="VB" AutoEventWireup="true" CodeFile="AirPort.aspx.vb" Inherits="AirPort" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crAirPort.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
    function GetQuery() {
...
<body onload="DivAutoSize(115);" onresize="DivAutoSize(115);">
    <form id="frmAirPort" runat="server">
        <div id="divTitle">
