<%@ Page Language="VB" AutoEventWireup="true" CodeFile="BusinessParty.aspx.vb" Inherits="BusinessParty" %>
...
<body onload="DivAutoSize(115);" onresize="DivAutoSize(115);">
    <form id="frmBusinessParty" runat="server">
    <div id="divTitle">
        &nbsp
    ...
    <div id="divSource" style="height: 560px;">
