<%@ Page Language="VB" AutoEventWireup="true" CodeFile="ContainerType.aspx.vb" Inherits="ContainerType" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crContainerType.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
  function GetQuery() 
