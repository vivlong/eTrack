<%@ Page Language="VB" AutoEventWireup="true" CodeFile="ShippingLine.aspx.vb" Inherits="ShippingLine" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crShippingLine.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
        function GetQuery() 
...
<body onload="DivAutoSize(115);" onresize="DivAutoSize(115);">
    <form id="frmShippingLine" runat="server">
        <div id="divTitle">
