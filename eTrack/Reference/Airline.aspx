<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Airline.aspx.vb" Inherits="Airline" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crAirline.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
        function GetQuery() 
