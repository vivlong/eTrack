<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Country.aspx.vb" Inherits="Country" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crCountry.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
   function GetQuery() 
