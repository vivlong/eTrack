<%@ Page Language="VB" AutoEventWireup="true" CodeFile="TypeSort.aspx.vb" Inherits="TypeSort" %>
...
<head runat="server">
    ...
    <link href="App_Themes/TypeSort.css" rel="Stylesheet" type="text/css" />
    <!-- #include file="../JavaScript/JsConst.js" -->
    <!-- #include file="../JavaScript/GridList.js" -->
    <!-- #include file="JavaScript/TypeSort.js" -->
