...
Partial Class AddressBook
    ...
    Protected Overrides Function NewObjectList(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String) As clsBaseSrv
        Return New clsAddressBook(strUserId, RoleName, strFunNo)
    End Function
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        MyBase.OnInit(e)
        Me.TableName = "vw_Rcab1"
...
objList = NewObjectList(objUser.UserId, objUser.RoleName, PageFun.GetFunNo(Page))
    ...
    Protected Sub gvwSource_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            strCustomerCode = CType(tmpProp, clsPropAddressBook).CustomerCode

            'Popupmenu
            If strCustomerCode <> "" Then
                e.Row.Attributes.Add("oncontextmenu", "ShowMenu(event," + strCustomerCode + ");return false;")
            End If
            'Row color
            ...
            If objList.DeletePrivilege AndAlso tmpProp.IsDeleted = 0 AndAlso Not tmpProp.IsAdd Then
                imgDelete.Attributes.Add("OnClick", "DeleteDetail(" + strCustomerCode + ");return false;")
            Else
            ...
            If objList.RestorePrivilege And tmpProp.IsDeleted = 1 And Not tmpProp.IsAdd Then
                imgRestore.Attributes.Add("OnClick", "UndeleteDetail(" + strCustomerCode + ");return false;")
            Else
            ...
            If objList.EditPrivilege AndAlso tmpProp.IsDeleted = 0 AndAlso Not tmpProp.IsAdd Then
                imgEdit.Attributes.Add("OnClick", "EditDetail(" + strCustomerCode + ");return false;")
                e.Row.Attributes.Add("ondblclick", "EditDetail(" + strCustomerCode + ");return false;")
            Else
            ...
            If (strCustomerCode <> "") AndAlso objList.PrintPrivilege Then
                imgPrint.Attributes.Add("OnClick", "PrintDetail(" + strCustomerCode + ");return false;")
            Else
