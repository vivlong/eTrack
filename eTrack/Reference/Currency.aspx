<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Currency.aspx.vb" Inherits="Currency" %>
...
<head>
    ...
    {
        if(intId){
            var strUrl="../loading.aspx?tourl="+PrintPath+"/crCurrency.aspx?Id="+intId.toString()+"";
            window.open(strUrl);
        }
    }
   function GetQuery() 
