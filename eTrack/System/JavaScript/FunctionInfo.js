...
//                   {
                  ...
                  return false;
                    ...
                    if(validateTextBox("lType",tr.cells[6].childNodes[0+ChildSpl].value)==false)
                  {
                  return false;
                  }
                  ...
                  return false;
                             ...
                             strFields+=tr.cells[7].childNodes[0+ChildSpl].value                            //ReleasedDate
                             strFields+="#";                                         
                         }
                         strAll+=strFields;
                   //}
...
function SetFISaveOne(result,context) 
{
    ...
    switch(strResult.length) {
       ...
       return false;
        ...
        context = document.getElementById("divSource");
        var arg = "FIUpdate"+ParSeparator+strslq+ParSeparator+TrxNo+ParSeparator+LineItemNo+ParSeparator+ContainerNo+ParSeparator+conField.id+ParSeparator+valField;
