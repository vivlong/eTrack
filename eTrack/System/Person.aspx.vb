...
Partial Class Person
    ...
    Protected Overrides Function BindSourceData(ByVal intUserId As String, ByVal intPage As Integer, ByVal intSize As Integer) As Boolean
        ...
        objList.Condition = objUser.RoleName
    ...
    Protected Overrides Function NewObjectList(ByVal strUserId As String, ByVal RoleName As String, ByVal strFunNo As String) As clsBaseSrv
        Return New clsPerson(strUserId, RoleName, strFunNo)
    End Function
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        MyBase.OnInit(e)
        Me.TableName = "Person"
        Me.MyGridView = gvwSource
        Me.CurrentSortField = "UserID"
        Me.SortDesc = False
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        If Not IsPostBack Then
            ...
            'Get First Page Data
            objList.Where = " and StatusCode!='DEL'"
            BindSourceData(objUser.UserId, 1, objUser.PagePara.InfoSize)
            InitSearchListField()
            'drop-081016
            drpStatus.Attributes.Add("OnChange", "GetQueryData(" + txtSearch.ClientID + ");return false;")
    ...
    Protected Sub gvwSource_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim i As Integer
            'KeyValue 
            Dim intId As String = CType(tmpProp, clsPropPerson).lUserID
            'Popupmenu
            If intId <> "" Then
            ...
            If (objList.DeletePrivilege Or objUser.UserId = "sa" Or objUser.UserId.ToLower = "s") AndAlso tmpProp.IsDeleted = 0 AndAlso Not tmpProp.IsAdd Then
        ...
        Else
            'Insert
            Dim imgInsert As Image = CType(e.Row.FindControl("imgInsert"), Image)
            If Not imgInsert Is Nothing Then
                imgInsert.Visible = False
